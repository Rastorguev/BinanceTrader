...
using BinanceApi.Models.General;
using BinanceApi.Models.Market;
using BinanceApi.Models.Market.TradingRules;
using BinanceApi.Models.UserStream;
using BinanceApi.Models.WebSocket;
using static BinanceApi.Domain.Abstract.ApiClientAbstract;

namespace BinanceApi.Domain.Interfaces
{
    public interface IBinanceClient
    {
        ...
        /// <param name="limit">Limit of records to retrieve.</param>
        /// <returns></returns>
        Task<IEnumerable<Candlestick>> GetCandleSticks(string symbol, TimeInterval interval, DateTime? startTime = null,
        ...
        /// <returns></returns>
        Task<NewOrder> PostNewOrder(string symbol, decimal quantity, decimal price, OrderSide side,
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        Task<dynamic> PostNewOrderTest(string symbol, decimal quantity, decimal price, OrderSide side,
            OrderType orderType = OrderType.Limit, TimeInForce timeInForce = TimeInForce.GTC, decimal icebergQty = 0m,
            long recvWindow = 60000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        Task<DepositHistory> GetDepositHistory(string asset, DepositStatus? status = null, DateTime? startTime = null,
            DateTime? endTime = null, long recvWindow = 60000);
        ...
        /// <param name="recvWindow">Specific number of milliseconds the request is valid for.</param>
        /// <returns></returns>
        Task<WithdrawHistory> GetWithdrawHistory(string asset, WithdrawStatus? status = null,
            DateTime? startTime = null, DateTime? endTime = null, long recvWindow = 60000);
        ...
        /// <returns></returns>
        string ListenUserDataEndpoint(MessageHandler<AccountUpdatedMessage> accountInfoHandler,
            MessageHandler<OrderOrTradeUpdatedMessage> tradesHandler,
            MessageHandler<OrderOrTradeUpdatedMessage> ordersHandler);
